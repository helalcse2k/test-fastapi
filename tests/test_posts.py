...
@pytest.mark.parametrize("title, content, published",[
    ...
    ("awesome new title2", "awesome new content2", False),
    ("awesome new title3", "awesome new content3", True),
])
...
def test_unauthorized_user_get_posts(client, test_user, test_posts):
